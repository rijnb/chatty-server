    ...
    const answerMessage: Message = { role: 'user', content: answerPrompt };
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Use the sources to provide an accurate response. Respond in markdown format. Cite the sources you used as [1](link), etc., as you use them. Maximum 5 sentences. End the response with "[Answer powered by Google] on a new line."`,
          },
          answerMessage,
        ],
        max_tokens: 1000,
